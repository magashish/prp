...
<head>
    ...
    <style>
        ...
        .header { background:#082B4D; color:#fff; padding:24px 32px; }
        .header h2 { margin:0; font-size:1.3rem; }
        .body { padding:32px; color:#333; line-height:1.6; }
        .booking-box { background:#e0f4f1; border-left:4px solid #082B4D; border-radius:4px; padding:16px; margin:20px 0; }
        ...
        .total-row td { font-weight:bold; font-size:1rem; color:#082B4D; }
        ...
        .footer { background:#f4f4f4; border-top:1px solid #dee2e6; padding:16px 32px; text-align:center; font-size:.8rem; color:#888; }
        .btn { display:inline-block; background:#0f4c81; color:#fff; text-decoration:none; padding:10px 24px; border-radius:4px; margin-top:12px; }
    </style>
</head>
<body>
<div class="wrapper">
