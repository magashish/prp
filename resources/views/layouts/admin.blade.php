...
<head>
    ...
    <style>
        ...
        .sidebar { width:240px; min-height:100vh; background:#1a3c5e; position:fixed; top:0; left:0; z-index:100; }
        .sidebar .nav-link { color:#cdd8e3; padding: .6rem 1.2rem; border-radius:6px; margin:2px 8px; }
        .sidebar .nav-link:hover, .sidebar .nav-link.active { background:#2d6a9f; color:#fff; }
        ...
        .badge-pass-sent { background:#198754; }
